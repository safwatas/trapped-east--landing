...
import { Search, Filter, MoreVertical, Phone, MessageCircle, CheckCircle, Clock, XCircle, AlertCircle } from 'lucide-react';
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="text-left p-4 text-sm font-medium text-[color:var(--text-muted)]">Total</th>
                ...
                {filteredBookings.map((booking) => {
                  ...
                  return (
                    <tr key={booking.id} className="border-b border-white/5 hover:bg-white/5">
                      ...
                      <td className="p-4 font-display font-semibold text-white">{booking.totalPrice} EGP</td>
                      <td className="p-4">
